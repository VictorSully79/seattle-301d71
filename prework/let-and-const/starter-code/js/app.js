...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT  The console log on line 38 threw an error because the variable only exists within the block of code.  The console.log was beyond the reach of the variabl.
  console.log(viewed);
